...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu1.add(new Menu(4,1,2,"Fried rice",50,"veg"));
        menu1.add(new Menu(5,1,2,"chicken fried rice",80,"non-veg"));
        menu1.add(new Menu(6,1,2,"Manchuria",100,"veg"));
        cacheMenuRes.add(new CacheMenuRes("fast food",menu1));
        List<Menu> menu2 = new ArrayList<>();
        menu2.add(new Menu(7,1,3,"chocolate Milkshake",50,"veg"));
        menu2.add(new Menu(8,1,3,"dry fruit shake",80,"veg"));
        menu2.add(new Menu(9,1,3,"banana orea shake",100,"veg"));
        cacheMenuRes.add(new CacheMenuRes("Milkshakes",menu2));
        List<Menu> menu3 = new ArrayList<>();
        menu3.add(new Menu(10,1,4,"veg biryani",90,"veg"));
        menu3.add(new Menu(11,1,4,"chicken biryani",180,"non-veg"));
        menu3.add(new Menu(12,1,4,"jeera rice",60,"veg"));
        cacheMenuRes.add(new CacheMenuRes("Rice",menu3));
        List<Menu> menu4 = new ArrayList<>();
        menu4.add(new Menu(13,1,5,"zinger burger",50,"non-veg"));
        menu4.add(new Menu(14,1,5,"bbq burger",80,"non-veg"));
        menu4.add(new Menu(15,1,5,"egg burger",40,"non-veg"));
        cacheMenuRes.add(new CacheMenuRes("Burgers",menu4));
